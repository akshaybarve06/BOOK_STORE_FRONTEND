<template>
          <div class='navbar'>
            ...
            <router-link to='/wishlist' class='link'><img svg-inline class='wishlist-icon' src='../assets/images/wishlist.png' alt='whishlist' /></router-link>
            <!-- <router-link to='/signin' class='link'><img svg-inline class='login-icon' src='../assets/images/user-login.png' alt='login' /></router-link> -->
